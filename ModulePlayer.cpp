...
/*
	...
	// ENGYNE FRONT LEFT ------------------------
	car.wheels[6].connection.Set(half_width + wheel_width * 0.5 + movementCoef, 2.5, half_length + 1);// (distancia en x del centro del coche, en z, en y)
	...
	// ENGYNE FRONT RIGHT ------------------------
	car.wheels[7].connection.Set(-half_width - wheel_width * 0.5 - movementCoef, 2.5, half_length + 1);// (distancia en x del centro del coche, en z, en y)
	...
	// ENGYNE BACK LEFT ------------------------
	car.wheels[8].connection.Set(half_width + wheel_width * 0.5 + movementCoef, 2.5, -half_length - 1);// (distancia en x del centro del coche, en z, en y)
	...
	// ENGYNE BACK RIGHT ------------------------
	car.wheels[9].connection.Set(-half_width - wheel_width * 0.5 - movementCoef, 2.5,- half_length - 1);// (distancia en x del centro del coche, en z, en y)
...
update_status ModulePlayer::Update(float dt)
{
	...
	{
		App->scene_intro->win_con = false;
		
		//App->player->Start();
		vehicle->SetPos(0, 0, 0);
		//vehicle->SetTransform({ 0 });
	}
